...
import { buildMeetingIcsDataUrl } from '../utils/calendar'

export default function CountdownScreen() {
  const { t } = useTranslation()
  const { days, hours, minutes, seconds, isComplete } = useCountdown(MEETING_DATE)
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-8 px-4 py-10 text-center">
      ...
      <CalendarButton
        href={buildMeetingIcsDataUrl(t('countdown.calendarSummary'))}
